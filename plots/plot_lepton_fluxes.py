...
Input_Folder='/Users/daniele/Dropbox/Fisica/2018/SFRproject/SF_GC/DRAGON-SF/'
Data_Folder='/Users/daniele/Dropbox/Fisica/2018/SFRproject/SF_GC/DRAGON-SF/'
Output_Folder='/Users/daniele/Dropbox/Fisica/2018/SFRproject/SF_GC/DRAGON-SF/'

Run_Names = ['run_3D_spike_propagated_-1000_step_50']
...
norm_DM = [1.0]             # normalization factor for the DM component
norm_extra = [1.0]             # normalization factor for the extra component
phi  = [0.5]                # modulation potential
colors_positrons = ['black']
colors_electrons = ['black']
colors_DM_component = ['black']
colors_extra_component = ['black']
